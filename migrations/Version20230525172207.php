 ...
 */
final class Version20230525172207 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE liste_de_lecture DROP lu');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE liste_de_lecture ADD lu TINYINT(1) NOT NULL');
