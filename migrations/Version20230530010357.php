 ...
 */
final class Version20230530010357 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE liste_de_lecture CHANGE manga_id manga_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE liste_de_lecture CHANGE manga_id manga_id INT NOT NULL');
